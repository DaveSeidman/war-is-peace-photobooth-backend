...
const prompts = {
  ...
  remove: "“Erase at least one person from each photo photo and restore the missing background so it looks natural. Keep lighting, colors, and composition identical. Keep the three photos in the same size and position. Do not change the overall composition of the image. Make sure to remove at least one person."
};
